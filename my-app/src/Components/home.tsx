    ...
    <div className="relative min-h-screen overflow-hidden bg-[#0C0F3A]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 z-20 h-screen flex items-center">
        ...
        >
          ...
          <motion.h1
            className="text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#00C2D1] to-[#CE67D3]"
          ...
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
            <Link to="/uploadImages">
              <button className="relative px-14 py-4 rounded-full bg-gradient-to-r from-[#00C2D1] to-[#CE67D3] text-white text-xl font-semibold overflow-hidden group">
